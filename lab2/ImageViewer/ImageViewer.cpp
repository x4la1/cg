...
// ImageViewer.cpp: определяет поведение классов для приложения.
//
...
// Единственный объект CImageViewerApp

CImageViewerApp theApp;


// Инициализация CImageViewerApp
...
BOOL CImageViewerApp::InitInstance()
{
	...
	try
	{
		m_initializer = std::make_unique<GdiPlusInitializer>();
	}
	catch(...)
	{
		AfxMessageBox(_T("GdiPlus: initialize failed."));
		return FALSE;
	}
...
// Обработчики сообщений CImageViewerApp
