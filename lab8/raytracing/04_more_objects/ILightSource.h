...
public:
	...
	*/
	...
	virtual Vector4f const& GetDiffuseIntensity()const = 0;
	...
	*/
	virtual double GetIntensityInDirection(Vector3d const& direction)const = 0;

	/*
	Направление на источник света из указанной точки, заданной в мировой системе координат
	*/
	virtual Vector3d GetDirectionFromPoint(Vector3d const& point)const = 0;
