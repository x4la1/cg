...
// CircleDrawer.cpp: определяет поведение классов для приложения.
//
...
// Единственный объект CCircleDrawerApp

CCircleDrawerApp theApp;


// Инициализация CCircleDrawerApp
...
BOOL CCircleDrawerApp::InitInstance()
{
	...
	pDocTemplate = new CSingleDocTemplate(
		IDR_MAINFRAME,
		RUNTIME_CLASS(CCircleDrawerDoc),
		RUNTIME_CLASS(CMainFrame),       // основное окно рамки SDI
		RUNTIME_CLASS(CCircleDrawerView));
	if (!pDocTemplate)
		return FALSE;
...
// Обработчики сообщений CCircleDrawerApp
