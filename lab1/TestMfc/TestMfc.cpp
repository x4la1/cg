...
BEGIN_MESSAGE_MAP(TestMfcApp, CWinApp)
	ON_COMMAND(ID_APP_ABOUT, &TestMfcApp::OnAppAbout)
...
TestMfcApp::TestMfcApp() noexcept
{
...
// Единственный объект TestMfcApp

TestMfcApp theApp;


// Инициализация TestMfcApp

BOOL TestMfcApp::InitInstance()
{
...
int TestMfcApp::ExitInstance()
{
	//TODO: обработайте дополнительные ресурсы, которые могли быть добавлены
	return CWinApp::ExitInstance();
}

// Обработчики сообщений TestMfcApp
